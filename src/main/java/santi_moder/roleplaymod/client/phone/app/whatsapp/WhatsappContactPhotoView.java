...
public final class WhatsappContactPhotoView {
    ...
    public void render(PhoneScreen screen, GuiGraphics guiGraphics, int mouseX, int mouseY, WhatsappState state) {
        ...
        guiGraphics.drawCenteredString(screen.getPhoneFont(), "Foto", screen.getPhoneCenterX(), screen.getPhoneY() + TITLE_Y, PhoneThemeColors.text(screen.getPhoneStack()));
        ...
        guiGraphics.drawCenteredString(screen.getPhoneFont(), contact.displayName(), centerX, centerY + PHOTO_RADIUS + 10, PhoneThemeColors.text(screen.getPhoneStack()));
    }
