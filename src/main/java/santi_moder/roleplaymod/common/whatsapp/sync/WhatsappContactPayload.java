...
public record WhatsappContactPayload(
        String id,
        String displayName,
        String phoneNumber,
        String photoId,
    ...
    public static void encode(FriendlyByteBuf buf, WhatsappContactPayload value) {
    ...
    public static WhatsappContactPayload decode(FriendlyByteBuf buf) {
